export const designData = {
  title: "Design",
  desc: "Discover our creative design solutions including UI/UX, branding, graphic design, and digital assets crafted to elevate your brand identity.",
  submenu: [
...
export const developmentData = {
  title: "Development",
  desc: "Explore our full-stack development services including web, app, software, and more tailored to scale your business.",
  submenu: [
...
export const marketingData = {
  ...
  submenu: [
    ...
    { title: "CRO", link: "/marketing/conversion-rate-optimisation" },
    {
...
import ncImg1 from "../assets/images/nc1.jpg";
import ncImg2 from "../assets/images/nc2.jpg";
import ncImg3 from "../assets/images/nc3.jpg";
...
export const navCards = [
  {
    ...
    devImg: ncImg2,
    mImg: ncImg1,
    title: "Download Our Company Profile PDF",
