        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-8 lg:gap-20 mb-12 sm:mb-16 md:mb-24">
            <div className="lg:flex-1">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-text-primary uppercase leading-[0.9] font-heading">
                Why Choose Us
              </h2>
            </div>
            <div className="lg:w-[400px]">
              <p className="text-sm sm:text-base lg:text-lg text-text-secondary leading-relaxed font-primary">
                We create comprehensive strategies designed to meet unique
                needs, providing full support throughout the entire process.
              </p>
            </div>
          </div>
